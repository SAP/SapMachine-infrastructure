...
def main(argv=None):
    ...
    version, version_part, major, update, version_sap, build_number, os_ext = utils.sapmachine_tag_components(args.tag)
    version_components = [version, version_part, major, update, version_sap, build_number, os_ext]
