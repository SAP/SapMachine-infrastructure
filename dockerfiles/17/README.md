...
The dockerfiles in this subdirectory define images for consuming the long term support release 17 (version: 17.0.19) of the SapMachine Java Virtual Machine (JVM).
