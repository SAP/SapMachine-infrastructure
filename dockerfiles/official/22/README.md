...
The dockerfiles in this subdirectory define images for consuming release 22 of the SapMachine Java Virtual Machine (JVM).
...
```console
docker pull sapmachine:22
docker run -it sapmachine:22 java -version
```
