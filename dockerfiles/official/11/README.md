...
The dockerfiles in this subdirectory define images for consuming the long term support release 11 (version: 11.0.20.1) of the SapMachine Java Virtual Machine (JVM).
