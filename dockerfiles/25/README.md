...
The dockerfiles in this subdirectory define images for consuming the long term support release 25 (version: 25.0.1) of the SapMachine Java Virtual Machine (JVM).
