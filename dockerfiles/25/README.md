...
The dockerfiles in this subdirectory define images for consuming the long term support release 25 (version: 25) of the SapMachine Java Virtual Machine (JVM).
