...
The dockerfiles in this subdirectory define images for consuming the long term support release 21 (version: 21.0.10.0.1) of the SapMachine Java Virtual Machine (JVM).
