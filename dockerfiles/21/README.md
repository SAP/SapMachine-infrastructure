...
The dockerfiles in this subdirectory define images for consuming the long term support release 21 (version: 21.0.8) of the SapMachine Java Virtual Machine (JVM).
